...
/// <param name="FavoritedByInGroup">Diccionario de ID de juego a lista de nombres de miembros del grupo que lo tienen como favorito.</param>
public sealed record UserGameStatusDto(
    ...
    IReadOnlyDictionary<int, IReadOnlyList<string>> FavoritedByInGroup
);
