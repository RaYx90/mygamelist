...
{
    /// <inheritdoc />
    public partial class AddCategoryAndAuthSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameFavorites", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GamePurchases_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameFavorites_GameId",
                table: "GameFavorites",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_GameFavorites_UserId_GameId",
                table: "GameFavorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GamePurchases_UserId_GameId",
                table: "GamePurchases",
                columns: new[] { "UserId", "GameId" },
                unique: true);
